...
public class Mainmenu extends JFrame{
	...
	private JScrollPane consolePanel (Result result){
		...
		if(result.wasSuccessful()){
			console.append("All system checks passed. (Junit tests passed: " + result.getRunCount() +")\n");
			console.append("Prototype 2 Loaded. Please load a CSV file.\n");
		}else{
			console.append("System checks not passed. (Junit tests passed: " + (result.getRunCount()-result.getFailureCount()) 
					+", Junit tests failed: " + result.getFailureCount() +")\n");
